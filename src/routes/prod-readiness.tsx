...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Server-side rules engine per institution and faculty (verified rules)", done: true },
      { label: "Saved learner profiles with subjects and marks (write UI)", done: true },
      { label: "Downloadable PDF match report", done: true },
      { label: "NBT flags and additional-test awareness (real dataset)", done: true },
    ],
  },
  {
    route: "/courses",
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Verified institution profiles with sourced data", done: true },
      { label: "Public institution status pulled from DHET directories", done: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Bilingual content (English + isiZulu first) - full page bodies", done: true },
    ],
  },
  {
    route: "/ask",
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Combined local check script for typecheck, tests, policies, build and budgets", done: true },
      { label: "Lint passes on a clean checkout", done: true },
      { label: "Automated unit, integration and browser test suite", done: true },
      { label: "CI enforcing typecheck, lint, build and tests", done: true },
      { label: "RLS and public API runtime test harness", done: true },
    ],
  },
  {
    route: "Platform",
