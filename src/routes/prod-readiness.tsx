...
const GROUPS: Group[] = [
  {
    ...
    features: [
      ...
      { label: "Personalised dashboard when signed in", done: false },
      { label: "Live application deadlines feed", done: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Lovable Cloud backend (Postgres, auth, storage)", done: false },
